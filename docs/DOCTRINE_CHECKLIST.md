...
| Round-trip and preservation tests are required before mutations | Text, notes, and metadata mutations inspect and validate edited output; targeted text replacement verifies unrelated media part preservation |
| Progress records must state changes, verification, risks, and next checkpoint | `docs/CHECKPOINTS.md` records Checkpoints 0, 1, 2, 3, and 4 completion evidence |
...
- Slide operations, image replacement mutation, and simple shape additions are not implemented yet.
