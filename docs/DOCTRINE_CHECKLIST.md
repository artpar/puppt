...
| Round-trip and preservation tests are required before mutations | Text, notes, metadata, and slide mutations inspect and validate edited output; targeted text replacement verifies unrelated media part preservation |
| Progress records must state changes, verification, risks, and next checkpoint | `docs/CHECKPOINTS.md` records Checkpoints 0, 1, 2, 3, 4, and 5 completion evidence |
...
- Image replacement mutation and simple shape additions are not implemented yet.
